			...
			<div class="panel-selector-section clearfix">
				...
				<div class="panel-selector-row clearfix">
                        <div class="color-item">
    				        <h3 class="panel-selector-title"><?php echo esc_html__('Primary Color','streamvid'); ?></h3>
                            <div style="background-color: <?php echo esc_attr($main_color); ?>" class="colorSelector" data-type="main"></div>
                        </div>
                        
                        <div class="color-item">
                            <h3 class="panel-selector-title"><?php echo esc_html__('Color 1','streamvid'); ?></h3>
                        ...
                        <div class="color-item">
                            <h3 class="panel-selector-title"><?php echo esc_html__('Body Color','streamvid'); ?></h3>
                        ...
                        <div class="color-item">
                            <h3 class="panel-selector-title"><?php echo esc_html__('Light Color','streamvid'); ?></h3>
