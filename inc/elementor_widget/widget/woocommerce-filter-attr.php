...
class Jws_Widget_Attributes_Filter extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Shows a custom attribute in a widget which lets you narrow down the list of products when viewing product categories.', 'streamvid' );
		$this->widget_id          = 'jws_attributes_filter';
		$this->widget_name        = esc_html__( 'Jws Attributes Filter', 'streamvid' );
		parent::__construct();
	}
	...
	public function init_settings() {
		...
		$this->settings = array(
			'title'      => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Filter by', 'streamvid' ),
				'label' => esc_html__( 'Title', 'streamvid' )
			),
			'attribute'  => array(
				'type'    => 'select',
				'std'     => '',
				'label'   => esc_html__( 'Attribute', 'streamvid' ),
				'options' => $attribute_array
			),
			'query_type' => array(
				'type'    => 'select',
				'std'     => 'and',
				'label'   => esc_html__( 'Query type', 'streamvid' ),
				'options' => array(
					'and' => esc_html__( 'AND', 'streamvid' ),
					'or'  => esc_html__( 'OR', 'streamvid' )
				)
			),
		);
	}
