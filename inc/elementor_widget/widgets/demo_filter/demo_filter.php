...
class Jws_Demo extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Demo', 'streamvid' );
	}
	...
	protected function register_controls() {
	    ...
	    $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'demo List', 'streamvid' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);   
        ...
        $repeater->add_control(
			'label_bg_color',
			[
				'label' => esc_html__( 'Label background', 'streamvid' ),
        ...
        $repeater->add_control(
			'enble_commingsoon',
			[
				'label' => esc_html__( 'Comming Soon', 'streamvid' ),
        ...
        $this->add_control(
			...
			[
				...
				'default' => [
					[
						'demo_title' => esc_html__( 'Name #1', 'streamvid' ),
					],
				],
                                ...
                                <a class="overlay" <?php echo ''.$this->get_render_attribute_string($link_key); ?>></a>
                                        ...
                                        <div class="jws_image_content_inner">
                                            <?php if($item['enble_commingsoon'] == 'yes') {
                                                echo '<span>'.esc_html__('Other demos','streamvid').'</span>';
                                                echo '<h4>'.esc_html__('Coming Soon','streamvid').'</h4>';
                                            }?>
                                        </div>
