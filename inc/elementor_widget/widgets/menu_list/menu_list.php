...
class Menu_list extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Menu list', 'streamvid' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => esc_html__( 'Icon List', 'streamvid' ),
			]
		);
        $this->add_control(
				'hover_skin',
				[
					'label'     => esc_html__( 'Hover Skin', 'streamvid' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'default',
					'options'   => [
						'default'   => esc_html__( 'Default', 'streamvid' ),
						'line_pd'   => esc_html__( 'Line And Padding', 'streamvid' ),
                        'line_sm'   => esc_html__( 'Line small', 'streamvid' ),
					],
        ...
        $this->add_control(
				...
				[
					...
					'default'   => '1',
					'options'   => [
						'1'   => esc_html__( '1 Column', 'streamvid' ),
						'2'   => esc_html__( '2 Columns', 'streamvid' ),
					],
                    'condition'	=> [
						'view' => 'traditional',
				    ]
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'traditional' => [
						'title' => esc_html__( 'Default', 'streamvid' ),
						'icon' => 'eicon-editor-list-ul',
					],
					'inline' => [
						'title' => esc_html__( 'Inline', 'streamvid' ),
        ...
        $this->add_control(
    			'use_tooltip',
    			[
    				'label' => esc_html__( 'Enable Tooltip', 'streamvid' ),
        ...
        $this->add_control(
    			'toggle_mobile',
    			[
    				'label' => esc_html__( 'Enable Toggle Show/Hide On Mobile', 'streamvid' ),
    				'type' => \Elementor\Controls_Manager::SWITCHER,
    				'label_on' => esc_html__( 'On', 'streamvid' ),
    				'label_off' => esc_html__( 'Off', 'streamvid' ),
    				'return_value' => 'true',
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => esc_html__( 'List Item', 'streamvid' ),
				'default' => esc_html__( 'List Item', 'streamvid' ),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'text' => esc_html__( 'List Item #1', 'streamvid' ),
						'selected_icon' => [
							'value' => 'fas fa-check',
							'library' => 'fa-solid',
						],
					...
					[
						'text' => esc_html__( 'List Item #2', 'streamvid' ),
						'selected_icon' => [
							'value' => 'fas fa-times',
							'library' => 'fa-solid',
						],
					...
					[
						'text' => esc_html__( 'List Item #3', 'streamvid' ),
						'selected_icon' => [
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-icon-list-items' => 'margin-top: {{SIZE}}px;',
		...
		$this->add_responsive_control(
			'space_between',
			[
				'label' => esc_html__( 'Space Between', 'streamvid' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_control(
			'divider',
			[
				'label' => esc_html__( 'Divider', 'streamvid' ),
        ...
        $this->add_control(
			'line_color',
			[
				'label' => esc_html__( 'Line Background', 'streamvid' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'text_indent',
			[
				'label' => esc_html__( 'Text Indent', 'streamvid' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
	...
	protected function render() {
		...
		if ( 'inline' === $settings['view'] ) {
		  ...
		  $this->add_render_attribute( 'icon_list', 'class', 'columns-'.$settings['columns'] );
		}
