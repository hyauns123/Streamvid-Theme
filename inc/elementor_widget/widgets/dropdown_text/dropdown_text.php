...
class Dropdown_Text extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Dropdown Text', 'streamvid' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
				'submenu',
				[
					'label'     => esc_html__( 'Menu Position', 'streamvid' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'bottom',
					'options'   => [
						'bottom'   => esc_html__( 'Bottom', 'streamvid' ),
        ...
        $this->add_control(
			'enble_icon',
			[
				'label' => esc_html__( 'Enble Icon', 'streamvid' ),
        ...
        $this->add_control(
			'title', [
				...
				'default' => esc_html__( 'English' , 'streamvid' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'sub_title', [
				'label' => esc_html__( 'Sub Title', 'streamvid' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'Sub Title' , 'streamvid' ),
				'label_block' => true,
			]
		);
        $repeater->add_control(
			'sub_url',
			[
				'label' => esc_html__( 'Sub Link', 'streamvid' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'sub_title' => esc_html__( 'Sub Title 1', 'streamvid' ),
					],
				],
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Top', 'streamvid' ),
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Sub', 'streamvid' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
         $this->add_control(
