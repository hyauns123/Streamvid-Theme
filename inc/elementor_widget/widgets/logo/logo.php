...
class Jws_Logo extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Logo', 'streamvid' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_image',
			[
				'label' => esc_html__( 'Image', 'streamvid' ),
			]
		);
        ...
        $this->add_control(
			'image_sticky',
			[
				'label' => esc_html__( 'Choose Image Sticky', 'streamvid' ),
				'type' => Controls_Manager::MEDIA,
			]
		);
        $this->add_control(
			'image_special',
			[
				'label' => esc_html__( 'Choose Image Special (Display when change slider)', 'streamvid' ),
				'type' => Controls_Manager::MEDIA,
			]
		);
        $this->add_control(
			...
			[
				...
				'default' => esc_html__( 'full', 'streamvid' ),
				'placeholder' => esc_html__( 'Add size for image, example 300x300 or full,thumbnail', 'streamvid' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'file' => esc_html__( 'Media File', 'streamvid' ),
					'custom' => esc_html__( 'Custom URL', 'streamvid' ),
				],
			]
		);
        ...
        $this->add_control(
				'enable_sticky',
				[
					'label'        => esc_html__( 'Enable Sticky', 'streamvid' ),
					'type'         => Controls_Manager::SWITCHER,
					'label_on'     => esc_html__( 'Yes', 'streamvid' ),
					'label_off'    => esc_html__( 'No', 'streamvid' ),
					'return_value' => 'yes',
					'default'      => '',
					'description'  => esc_html__( 'Enable custom for sticky', 'streamvid' ),
