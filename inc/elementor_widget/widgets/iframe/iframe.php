...
class Iframe extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Iframe', 'streamvid' );
	}
	...
	protected function register_controls() {
       ...
       $this->add_control(
			'embed',
			[
			    'label' => esc_html__( 'Embed Url', 'streamvid' ),
        ...
        $this->add_control(
			'width',
			[
			    'label' => esc_html__( 'Embed Width', 'streamvid' ),
				'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( '1920', 'streamvid' ),
			]
		);
        $this->add_control(
			'height',
			[
			    'label' => esc_html__( 'Embed Height', 'streamvid' ),
				'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( '964', 'streamvid' ),
			]
		);
