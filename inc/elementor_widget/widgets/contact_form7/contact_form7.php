...
class Jws_cf7 extends Widget_Base {
	...
	protected function get_cf7_forms() {
		...
		if ( empty( $field_options ) ) {
			$field_options = array(
				'-1' => esc_html__( 'You have not added any Contact Form 7 yet.', 'streamvid' ),
			);
		}
	...
	protected function register_general_content_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'select_form',
				[
					'label'   => esc_html__( 'Select Form', 'streamvid' ),
					'type'    => Controls_Manager::SELECT,
					'options' => $this->get_cf7_forms(),
					'default' => '0',
					'help'    => esc_html__( 'Choose the form that you want for this page for styling', 'streamvid' ),
				]
			);
			...
			$this->add_control(
				'cf7_style',
				[
					'label'        => esc_html__( 'Field Style', 'streamvid' ),
					'type'         => Controls_Manager::SELECT,
					'default'      => 'box',
					'options'      => [
						'box'       => esc_html__( 'Box', 'streamvid' ),
			...
			$this->add_control(
				'input_size',
				[
					'label'        => esc_html__( 'Field Size', 'streamvid' ),
					'type'         => Controls_Manager::SELECT,
					'default'      => 'sm',
					'options'      => [
			...
			$this->add_responsive_control(
				'cf7_input_padding',
				[
					'label'      => esc_html__( 'Field Padding', 'streamvid' ),
			...
			$this->add_control(
				'cf7_input_bgcolor',
				[
					'label'     => esc_html__( 'Field Background Color', 'streamvid' ),
			...
			$this->add_control(
				'cf7_label_color',
				[
					'label'     => esc_html__( 'Label Color', 'streamvid' ),
					'type'      => Controls_Manager::COLOR,
					'default'   => '',
					'selectors' => [
			...
			$this->add_control(
				'cf7_input_color',
				[
					'label'     => esc_html__( 'Input Text / Placeholder Color', 'streamvid' ),
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				'input_border_style',
				[
					'label'       => esc_html__( 'Border Style', 'streamvid' ),
					'type'        => Controls_Manager::SELECT,
					'default'     => 'solid',
					'label_block' => false,
					'options'     => [
			...
			$this->add_control(
				'input_border_size',
				[
					'label'      => esc_html__( 'Border Width', 'streamvid' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px' ],
					'default'    => [
						'top'    => '1',
			...
			$this->add_responsive_control(
				'cf7_border_bottom',
				[
					'label'      => esc_html__( 'Border Size', 'streamvid' ),
			...
			$this->add_control(
				'cf7_ipborder_active',
				[
					'label'     => esc_html__( 'Border Active Color', 'streamvid' ),
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_responsive_control(
				'cf7_input_radius',
				[
					'label'      => esc_html__( 'Rounded Corners', 'streamvid' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
			...
			$this->add_responsive_control(
				'cf7_text_align',
				[
					'label'     => esc_html__( 'Field Alignment', 'streamvid' ),
	...
	protected function register_radio_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Radio & Checkbox', 'streamvid' ),
			]
		);
			...
			$this->add_control(
				'cf7_radio_check_adv',
				[
					'label'        => esc_html__( 'Override Current Style', 'streamvid' ),
			...
			$this->add_control(
				'cf7_selected_color',
				[
					'label'     => esc_html__( 'Selected Color', 'streamvid' ),
					'type'      => Controls_Manager::COLOR,
					'condition' => [
						'cf7_radio_check_adv!' => '',
					],
			...
			$this->add_control(
				...
				[
					'label'      => esc_html__( 'Checkbox Rounded Corners', 'streamvid' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%' ],
					'condition'  => [
						'cf7_radio_check_adv!' => '',
	...
	protected function register_textarea_content_controls() {
	   	$this->start_controls_section(
			'cf7_textarea',
			[
				'label' => esc_html__( 'Textarea', 'streamvid' ),
			]
		);
        $this->add_responsive_control(
				'cf7_textarea_height',
	...
	protected function register_button_content_controls() {
		...
		$this->start_controls_section(
			'cf7_submit_button',
			[
				'label' => esc_html__( 'Submit Button', 'streamvid' ),
			]
		);
			...
			$this->add_responsive_control(
				'cf7_button_align',
				[
					'label'        => esc_html__( 'Button Alignment', 'streamvid' ),
					'type'         => Controls_Manager::CHOOSE,
					'options'      => [
						'left'    => [
							'title' => esc_html__( 'Left', 'streamvid' ),
	...
	protected function register_error_content_controls() {
		...
		$this->start_controls_section(
			'cf7_error_field',
			[
				'label' => esc_html__( 'Success / Error Message', 'streamvid' ),
			]
		);
			...
			$this->add_control(
				'cf7_field_message',
				[
					'label'     => esc_html__( 'Field Validation', 'streamvid' ),
				...
				$this->add_control(
					'cf7_highlight_style',
					[
						'label'        => esc_html__( 'Message Position', 'streamvid' ),
						'type'         => Controls_Manager::SELECT,
						'default'      => 'default',
						'options'      => [
							'default'      => esc_html__( 'Default', 'streamvid' ),
							'tooltip' => esc_html__( 'Tooltip', 'streamvid' ),
						],
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Message Color', 'streamvid' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '#ffffff',
						'condition' => [
				...
				$this->add_control(
					'cf7_message_bgcolor',
					[
						'label'     => esc_html__( 'Message Background Color', 'streamvid' ),
						'type'      => Controls_Manager::COLOR,
				...
				$this->add_control(
					...
					[
						'label'        => esc_html__( 'Highlight Borders', 'streamvid' ),
						'type'         => Controls_Manager::SWITCHER,
						'label_on'     => esc_html__( 'Yes', 'streamvid' ),
						'label_off'    => esc_html__( 'No', 'streamvid' ),
						'return_value' => 'yes',
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Highlight Border Color', 'streamvid' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '#ff0000',
						'condition' => [
			...
			$this->add_control(
				...
				[
					'label'     => esc_html__( 'Form Success / Error Validation', 'streamvid' ),
					'type'      => Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Success Message Color', 'streamvid' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Success Message Background Color', 'streamvid' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Success Border Color', 'streamvid' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '#008000',
						'condition' => [
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Error Message Color', 'streamvid' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Error Message Background Color', 'streamvid' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Error Border Color', 'streamvid' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '#ff0000',
						'condition' => [
							'cf7_valid_border_size!' => '',
				...
				$this->add_responsive_control(
					...
					[
						'label'      => esc_html__( 'Message Padding', 'streamvid' ),
						'type'       => Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', 'em', '%' ],
						'selectors'  => [
                ...
                $this->add_responsive_control(
					...
					[
						'label'      => esc_html__( 'Message Margin', 'streamvid' ),
						'type'       => Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', 'em', '%' ],
						'selectors'  => [
	...
	protected function register_input_style_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					'label'      => esc_html__( 'Between Label & Input', 'streamvid' ),
					'type'       => Controls_Manager::SLIDER,
					'size_units' => [ 'px', 'em', 'rem' ],
					'range'      => [
						'px' => [
			...
			$this->add_responsive_control(
				...
				[
					'label'      => esc_html__( 'Between Fields', 'streamvid' ),
					'type'       => Controls_Manager::SLIDER,
					'size_units' => [ 'px', 'em', 'rem' ],
					'range'      => [
						'px' => [
	...
	protected function register_typography_style_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'cf7_label_typo',
				[
					'label'     => esc_html__( 'Form Label', 'streamvid' ),
					'type'      => Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
			...
			$this->add_control(
				'cf7_input_typo',
				[
					'label'     => esc_html__( 'Input Text / Placeholder', 'streamvid' ),
					'type'      => Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
			...
			$this->add_control(
				...
				[
					'label'     => esc_html__( 'Radio Button & Checkbox', 'streamvid' ),
					'type'      => Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
						'cf7_radio_check_adv!' => '',
	...
	protected function register_helpful_information() {
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf( esc_html__( '%1$s Getting started video » %2$s', 'streamvid' ), '<a href="https://www.youtube.com/watch?v=qhFfKf2R-SM&list=PL1kzJGWGPrW_7HabOZHb6z88t_S8r-xAc&index=8" target="_blank" rel="noopener">', '</a>' ),
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf( esc_html__( '%1$s Display input fields in column » %2$s', 'streamvid' ), '<a href="https://jwsementor.com/docs/how-to-set-multiple-column-fields-in-contact-form-7-styler-of-jws/?utm_source=streamvid-dashboard&utm_medium=jws-editor-screen&utm_campaign=streamvid-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'jws-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf( esc_html__( '%1$s Unable to see Checkbox / Radio / Acceptance control » %2$s', 'streamvid' ), '<a href="https://jwsementor.com/docs/unable-to-style-checkbox-radio-buttons-acceptance-control-using-contact-form-7-styler-of-jws/?utm_source=streamvid-dashboard&utm_medium=jws-editor-screen&utm_campaign=streamvid-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'jws-editor-doc',
				]
			);
	...
	protected function render() {
		...
		$forms              = get_posts( $args );
		$field_options['0'] = esc_html__( 'select', 'streamvid' );
		if ( $forms ) {
			foreach ( $forms as $form ) {
				$field_options[ $form->ID ] = $form->post_title;
			}
		...
		if ( ! empty( $forms ) && ! isset( $forms[-1] ) ) {
			if ( '0' === $settings['select_form'] ) {
				$html = esc_html__( 'Please select a Contact Form 7.', 'streamvid' );
			} else {
				?>
			...
			$html = esc_html__( 'You have not added any Contact Form 7 yet.', 'streamvid' );
		}
