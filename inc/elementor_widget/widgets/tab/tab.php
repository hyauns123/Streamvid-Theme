...
class Jws_tab extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Tab', 'streamvid' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'default' => 'top',
				'options' => [
					'top'  => esc_html__( 'Top', 'streamvid' ),
                    'left'  => esc_html__( 'Left', 'streamvid' ),
                    'right'  => esc_html__( 'Right', 'streamvid' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'list_title' => esc_html__( 'Nav #1', 'streamvid' ),
					],
				],
        ...
        $this->start_controls_section(
			'nav_style',
			[
				'label' => esc_html__( 'Nav', 'streamvid' ),
        ...
        $this->add_control(
			'absolute',
			[
				'label' => esc_html__( 'Tab Position Absolute', 'streamvid' ),
        ...
        $this->add_control(
				'vertical',
				[
					'label' 		=> esc_html__( 'Vertical Orientation', 'streamvid' ),
        ...
        $this->add_control(
				'horizontal',
				[
					'label' 		=> esc_html__( 'Horizontal Orientation', 'streamvid' ),
					'type' 			=> Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
					'range' => [
        					'px' => [
        ...
        $this->add_control(
			'nav_item_style',
			[
				'label' => esc_html__( 'Item', 'streamvid' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Background Color Active', 'streamvid' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
            		  ...
            		  <?php $content = 1; foreach (  $settings['list'] as $item ) { ?>
            				<div id="<?php echo esc_attr($item['_id']); ?>" class="jws_tab_item<?php if($content == 1) echo " current"; ?>">
                                    ...
                                    if($item['content_layout'] == 'template') {
                                      echo do_shortcode('[hf_template  id="'.$item['select_template'].'"]');  
                                    }else {
