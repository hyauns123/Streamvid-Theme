 ...
 * @since 1.0.0
 */
class Jws_Videos_Advanded extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Videos Advanced', 'streamvid' );
	}
	...
	*/
	protected function register_content_general_controls() {
        ...
        $this->add_control(
			'post_related',
			[
				'label' => esc_html__( 'Show post related for single videos_advanced', 'streamvid' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'streamvid' ),
				'label_off' => esc_html__( 'Off', 'streamvid' ),
				'return_value' => 'yes',
	...
	protected function register_content_filter_controls() {
		...
		$this->add_control(
			...
			'show_lives',
			[
				'label'        => esc_html__( 'Show only videos live stream.', 'streamvid' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => '',
            	'condition' => [
			...
			$this->add_control(
				...
				[
					...
					'multiple'  => true,
					'default'   => '',
					'options'   => $this->get_videos_advanced_categories(),
					'condition' => [
						'query_type' => 'custom',
					],
				]
			...
			$this->add_control(
				...
				[
					...
					'multiple'  => true,
					'default'   => '',
					'options'   => $this->get_videos_advanced_tags(),
					'condition' => [
						'query_type' => 'custom',
					],
				]
	   ...
	   $this->start_controls_section(
		...
		$this->start_controls_section(
			...
			[
				...
				'type'      => Controls_Manager::SECTION,
				'condition' => [
					'videos_advanced_display' => ['slider'],
				],
			]
		);
        ...
        $this->add_responsive_control(
			'item_slider_width',
			[
				'label'     => esc_html__( 'Add Width For Item (px) ', 'streamvid' ),
				'type'      => Controls_Manager::SLIDER,
                'size_units' => ['px','%'],
                'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .jws-videos-advanced-slider:not(.slick-initialized) .post-inner' => 'max-width: {{SIZE}}px;',
				],
                'condition'    => [
					'variablewidth!'  => 'yes',
				],
        ...
        $this->add_responsive_control(
			'item_height',
			[
				'label'     => esc_html__( 'Item Min Height', 'streamvid' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 200,
				...
				'selectors' => [
					'{{WRAPPER}} .post-inner' => 'min-height:  {{SIZE}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .videos_advanced_content.row' => 'margin-left: calc( -{{SIZE}}{{UNIT}}/2 ); margin-right: calc( -{{SIZE}}{{UNIT}}/2 );',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jws-videos-advanced_item' => 'text-align: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '',
				'selectors' => [
					'{{WRAPPER}} .jws-videos-advanced-element .jws-videos-advanced_item .post-inner .jws_post_content .entry-title a' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_control(
			...
			[
                ...
                'default' => '',
				'selectors' => [
					'{{WRAPPER}} .jws-videos-advanced-element .jws-videos-advanced_item .post-inner .jws_post_content .entry-title a:hover' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jws-videos-advanced-element .jws-videos-advanced_item .post-inner .jws_post_content .entry-title',
			]
		);
        ...
        $this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%' ],
						'selectors' 	=> [
							'{{WRAPPER}} .jws-videos-advanced-element .jws-videos-advanced_item .post-inner .jws_post_content .entry-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jws-videos-advanced-element .jws-videos-advanced_item .post-inner .jws_post_content .entry-title:hover',
			]
		);
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jws-videos-advanced-element .jws-videos-advanced_item .post-inner .jws_post_content .entry-title a:hover' => 'text-decoration-color: {{VALUE}}; -webkit-text-decoration-color:{{VALUE}};-moz-text-decoration-color: {{VALUE}}',
				],
			]
		);
        $this->end_controls_section();
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jws-videos-advanced-element .post-inner .jws_post_excerpt' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'streamvid' ),
				'selector' => '{{WRAPPER}} .jws-videos-advanced-element .post-inner .jws_post_excerpt',
			]
		);
        $this->add_responsive_control(
					'excerpt_margin',
					[
						...
						'size_units' 	=> [ 'px', 'em', '%' ],
						'selectors' 	=> [
							'{{WRAPPER}} .jws-videos-advanced-element .post-inner .jws_post_excerpt' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jws-videos-advanced-element .post-inner .entry-date a' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'streamvid' ),
				'selector' => '{{WRAPPER}} .jws-videos-advanced-element .post-inner .entry-date',
			]
		);
        $this->add_responsive_control(
					'date_margin',
					[
						...
						'size_units' 	=> [ 'px', 'em', '%' ],
						'selectors' 	=> [
							'{{WRAPPER}} .jws-videos-advanced-element .post-inner .entry-date' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '',
				'selectors' => [
					'{{WRAPPER}} .jws-videos-advanced-element .post-inner .jws_post_content .jws_post_readmore' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_control(
			...
			[
                ...
                'default' => '',
				'selectors' => [
					'{{WRAPPER}} .jws-videos-advanced-element .post-inner .jws_post_content .jws_post_readmore:hover' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'streamvid' ),
				'selector' => '{{WRAPPER}} .jws-videos-advanced-element .post-inner .jws_post_content .jws_post_readmore',
			]
		);
        $this->add_responsive_control(
					'readmore_margin',
					[
						...
						'size_units' 	=> [ 'px', 'em', '%' ],
						'selectors' 	=> [
							'{{WRAPPER}} .jws-videos-advanced-element .post-inner .jws_post_content .jws_post_readmore' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
	 ...
	 * @access protected
	 */
	protected function get_videos_advanced_categories() {

		$videos_advanced_cat = array();
		...
		$videos_advanced_categories = get_terms( 'videos_cat', $cat_args );

		if ( ! empty( $videos_advanced_categories ) ) {

			foreach ( $videos_advanced_categories as $key => $category ) {
				$videos_advanced_cat[ $category->term_id ] = $category->name;
			}
		}

		return $videos_advanced_cat;
	}
    /**
	 ...
	 * @access protected
	 */
	protected function get_videos_advanced_tags() {

		$videos_advanced_return = array();
		...
		$videos_advanced_tag = get_terms( 'videos_tag', $tag_args );

		if ( ! empty( $videos_advanced_tag ) ) {

			foreach ( $videos_advanced_tag as $key => $tag ) {

				$videos_advanced_return[ $tag->term_id ] = $tag->name;
			}
		}

		return $videos_advanced_return;
	}
	/**
	...
	protected function render() {
		...
		$settings = $this->get_settings();
		    ...
		    if ( $settings['videos_advanced_per_page'] > 0 ) {
				$query_args['posts_per_page'] = $settings['videos_advanced_per_page'];
			}
			...
			if ( 'manual' !== $settings['query_type'] && 'main' !== $settings['query_type'] ) {
			 ...
			 $videos_advanced = new \WP_Query( $query_args );

              $class_row = 'row videos-advanced-content';  
              $class_row .= ' '.$settings['videos_advanced_layouts'].'';
              $class_row .= ' videos-advanced-ajax-'.$this->get_id().''; 
              if ( $videos_advanced->max_num_pages > 1) { $class_row.= ' jws_has_pagination'; }
      
            $class_column = 'jws-post-item';
     
      
      if($settings['videos_advanced_display'] == 'slider') {
            $class_row .= ' owl-carousel jws-videos-advanced-'.$settings['videos_advanced_display'].'';
           ...
           $class_column .= ' col-xl-'.$settings['videos_advanced_columns'].'';
           $class_column .= (!empty($settings['videos_advanced_columns_tablet'])) ? ' col-lg-'.$settings['videos_advanced_columns_tablet'].'' : ' col-lg-'.$settings['videos_advanced_columns'].'' ;
           $class_column .= (!empty($settings['videos_advanced_columns_mobile'])) ? ' col-'.$settings['videos_advanced_columns_mobile'].'' :  ' col-'.$settings['videos_advanced_columns'].'';
       ...
       if($settings['enable_animation'] == 'yes') {
        ...
        if($settings['post_related'] == 'yes' && !\Elementor\Plugin::$instance->editor->is_edit_mode()){
            ...
            $args = array( 
              ...
              'post_type'		=> 'videos', // or 'post', 'page'
              'orderby' 		=> 'title', // or 'date', 'rand'
              'tax_query' => array(
                array(
                    'taxonomy' => 'videos_cat',
                    'field'    => 'term_id',
                    'terms'    =>wp_get_object_terms( $post->ID, 'videos_cat', array('fields' => 'ids') ),
                ),
             ),
              'post__not_in' => array($post->ID) 
            );
            $videos_advanced = new \WP_Query( $args );
           
        
        }
      $image_size_global = jws_theme_get_option('videos_imagesize');  
      $image_size = !empty($settings['videos_advanced_image_size']['width']) && !empty($settings['videos_advanced_image_size']['height']) ?  $settings['videos_advanced_image_size']['width'].'x'.$settings['videos_advanced_image_size']['height'] : $image_size_global;
      ...
      ?>
		...
		<div class="jws-videos-advanced-element<?php if($settings['post_nav_on'] == 'yes') echo esc_attr(' has-nav'); ?>">
            
            <?php  if($settings['post_related'] == 'yes' && $videos_advanced->have_posts()) echo '<h5 class="title-related">'.esc_html($settings['title_related']).'</h5>'; ?> 
            ...
            <div class="<?php echo esc_attr($class_row); ?>"  <?php echo ''.$data_slick; ?>>
                <?php 
                    ...
                    if($settings['post_archive'] == 'yes') {
                            ...
                            while ( have_posts() ) :
                                    ...
                                    $format = has_post_format() ? get_post_format() : 'no_format';  
                                        echo '<div class="'.$class_column.' '.$format.'">';
                                               ...
                                               get_template_part( 'template-parts/content/videos/layout/'.$settings['videos_advanced_layouts'].'' , '' ,$args ); 
                     ...
                     $i = 1; if ($videos_advanced->have_posts()) :
                            while ( $videos_advanced->have_posts() ) :
                        			$videos_advanced->the_post();
                                    $class_slug = '';
            ...
            <?php 
                ...
                if($settings['post_archive'] == 'yes') { 
                   ...
                   $number_page = $videos_advanced->max_num_pages;
                   $pagi_number = jws_query_pagination($videos_advanced);
                   $url = get_next_posts_page_link( $wp_query->max_num_pages ); 
                }
 
           ?>
            <?php if ( $number_page > 1 && $settings['pagination_type'] == 'load_more' ) {
                 $load_attr = 'data-ajaxify-options=\'{"wrapper":".videos_advanced_ajax_'.$this->get_id().'","items":"> .jws-videos-advanced_item","trigger":"click"}\''; 
