 ...
 * @since 1.0.0
 */
class Jws_Person_Advanded extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Person Advanced', 'streamvid' );
	}
	...
	*/
	protected function register_content_general_controls() {
        ...
        $this->add_control(
			'post_related',
			[
				'label' => esc_html__( 'Show post related for single person_advanced', 'streamvid' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'streamvid' ),
				'label_off' => esc_html__( 'Off', 'streamvid' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			$this->add_control(
				...
				[
					...
					'multiple'  => true,
					'default'   => '',
					'options'   => $this->get_person_advanced_categories(),
					'condition' => [
						'query_type' => 'custom',
					],
				]
	...
	protected function register_content_slider_controls() {
		...
		$this->start_controls_section(
			...
			[
				...
				'type'      => Controls_Manager::SECTION,
				'condition' => [
					'person_advanced_display' => ['slider'],
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .person-advanced-content.row' => 'margin-left: calc( -{{SIZE}}{{UNIT}}/2 ); margin-right: calc( -{{SIZE}}{{UNIT}}/2 );',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jws-person-advanced_item' => 'text-align: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '',
				'selectors' => [
					'{{WRAPPER}} .jws-person-advanced-element .jws-person-advanced_item .post-inner .jws_post_content .entry-title a' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_control(
			...
			[
                ...
                'default' => '',
				'selectors' => [
					'{{WRAPPER}} .jws-person-advanced-element .jws-person-advanced_item .post-inner .jws_post_content .entry-title a:hover' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jws-person-advanced-element .jws-person-advanced_item .post-inner .jws_post_content .entry-title',
			]
		);
        ...
        $this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%' ],
						'selectors' 	=> [
							'{{WRAPPER}} .jws-person-advanced-element .jws-person-advanced_item .post-inner .jws_post_content .entry-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jws-person-advanced-element .jws-person-advanced_item .post-inner .jws_post_content .entry-title:hover',
			]
		);
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jws-person-advanced-element .jws-person-advanced_item .post-inner .jws_post_content .entry-title a:hover' => 'text-decoration-color: {{VALUE}}; -webkit-text-decoration-color:{{VALUE}};-moz-text-decoration-color: {{VALUE}}',
				],
			]
		);
        $this->end_controls_section();
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jws-person-advanced-element .post-inner .jws_post_excerpt' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'streamvid' ),
				'selector' => '{{WRAPPER}} .jws-person-advanced-element .post-inner .jws_post_excerpt',
			]
		);
        $this->add_responsive_control(
					'excerpt_margin',
					[
						...
						'size_units' 	=> [ 'px', 'em', '%' ],
						'selectors' 	=> [
							'{{WRAPPER}} .jws-person-advanced-element .post-inner .jws_post_excerpt' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jws-person-advanced-element .post-inner .entry-date a' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'streamvid' ),
				'selector' => '{{WRAPPER}} .jws-person-advanced-element .post-inner .entry-date',
			]
		);
        $this->add_responsive_control(
					'date_margin',
					[
						...
						'size_units' 	=> [ 'px', 'em', '%' ],
						'selectors' 	=> [
							'{{WRAPPER}} .jws-person-advanced-element .post-inner .entry-date' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '',
				'selectors' => [
					'{{WRAPPER}} .jws-person-advanced-element .post-inner .jws_post_content .jws_post_readmore' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_control(
			...
			[
                ...
                'default' => '',
				'selectors' => [
					'{{WRAPPER}} .jws-person-advanced-element .post-inner .jws_post_content .jws_post_readmore:hover' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'streamvid' ),
				'selector' => '{{WRAPPER}} .jws-person-advanced-element .post-inner .jws_post_content .jws_post_readmore',
			]
		);
        $this->add_responsive_control(
					'readmore_margin',
					[
						...
						'size_units' 	=> [ 'px', 'em', '%' ],
						'selectors' 	=> [
							'{{WRAPPER}} .jws-person-advanced-element .post-inner .jws_post_content .jws_post_readmore' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
	 ...
	 * @access protected
	 */
	protected function get_person_advanced_categories() {

		$person_advanced_cat = array();
		...
		$person_advanced_categories = get_terms( 'person_cat', $cat_args );

		if ( ! empty( $person_advanced_categories ) ) {

			foreach ( $person_advanced_categories as $key => $category ) {
				$person_advanced_cat[ $category->term_id ] = $category->name;
			}
		}

		return $person_advanced_cat;
	}
    /**
	 ...
	 * @access protected
	 */
	protected function get_person_advanced_tags() {

		$person_advanced_tag = array();
		...
		$person_advanced_tag = get_terms( 'post_tag', $tag_args );

		if ( ! empty( $person_advanced_tag ) ) {

			foreach ( $person_advanced_tag as $key => $tag ) {

				$person_advanced_tag[ $tag->term_id ] = $tag->name;
			}
		}

		return $person_advanced_tag;
	}
	/**
	...
	protected function render() {
		...
		$settings = $this->get_settings();
		    ...
		    if ( $settings['person_advanced_per_page'] > 0 ) {
				$query_args['posts_per_page'] = $settings['person_advanced_per_page'];
			}
			...
			$person_advanced = new \WP_Query( $query_args );

      $class_row = 'row person-advanced-content';  
      $class_row .= ' '.$settings['person_advanced_layouts'].'';
      $class_row .= ' person-advanced-ajax-'.$this->get_id().''; 
      if ( $person_advanced->max_num_pages > 1) { $class_row.= ' jws_has_pagination'; }
      
      $class_column = 'jws-post-item';

      if($settings['person_advanced_display'] == 'slider') {
            $class_row .= ' owl-carousel jws-person-advanced-'.$settings['person_advanced_display'].'';
            ...
            $data_slick = '';
            $class_column .= ' col-xl-'.$settings['person_advanced_columns'].'';
            $class_column .= (!empty($settings['person_advanced_columns_tablet'])) ? ' col-lg-'.$settings['person_advanced_columns_tablet'].'' : ' col-lg-'.$settings['person_advanced_columns'].'' ;
            $class_column .= (!empty($settings['person_advanced_columns_mobile'])) ? ' col-'.$settings['person_advanced_columns_mobile'].'' :  ' col-'.$settings['person_advanced_columns'].'';
      ...
      $image_size_global = jws_theme_get_option('person_imagesize');    
      $image_size = !empty($settings['person_advanced_image_size']['width']) && !empty($settings['person_advanced_image_size']['height']) ?  $settings['person_advanced_image_size']['width'].'x'.$settings['person_advanced_image_size']['height'] : $image_size_global;
      ...
      ?>
		...
		<div class="jws-person-advanced-element<?php if($settings['post_nav_on'] == 'yes') echo esc_attr(' has-nav'); ?>">
            ...
            <div class="<?php echo esc_attr($class_row); ?>"  <?php echo ''.$data_slick; ?>>
                <?php 
                    ...
                    if($settings['post_archive'] == 'yes') {
                            ...
                            while ( have_posts() ) :
                                    ...
                                    $format = has_post_format() ? get_post_format() : 'no_format';  
                                        echo '<div class="'.$class_column.' '.$format.'">';
                                             ...
                                             get_template_part( 'template-parts/content/person/layout/'.$settings['person_advanced_layouts'].'' , '' , $args );
                     ...
                     $i = 1; if ($person_advanced->have_posts()) :
                            while ( $person_advanced->have_posts() ) :
                        			$person_advanced->the_post();
                                    $class_slug = '';
            ...
            <?php 
                ...
                if($settings['post_archive'] == 'yes') { 
                   ...
                   $number_page = $person_advanced->max_num_pages;
                   $pagi_number = jws_query_pagination($person_advanced);
                   $url = get_next_posts_page_link( $wp_query->max_num_pages ); 
                }
 
           ?>
            <?php if ( $number_page > 1 && $settings['pagination_type'] == 'load_more' ) {
                 $load_attr = 'data-ajaxify-options=\'{"wrapper":".person_advanced_ajax_'.$this->get_id().'","items":"> .jws-person-advanced_item","trigger":"click"}\''; 
