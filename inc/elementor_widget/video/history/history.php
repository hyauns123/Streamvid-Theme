 ...
 * @since 1.0.0
 */
class Jws_History extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws History', 'streamvid' );
	}
	...
	*/
	...
	protected function render() {
      ...
      ?>
		...
		<div class="jws-history-element">
        
            <?php  echo '<h5 class="title-history">'.esc_html($settings['title_history']).'</h5>'; ?> 
                ...
                if(is_user_logged_in()) {
                      ...
                      foreach($video_progress_data as $id => $history) { 
                            ...
                            echo '<div class="jws-post-item col-xl-2 col-lg-4 col-md-6 col-12">';
                                get_template_part( 'template-parts/content/content-history2' , '' , $args );
                            echo '</div>';
                      }
