...
class Jws_Section extends Elementor\Element_Section {
	...
	protected static function get_default_edit_tools() {
		$section_label = __( 'Section', 'streamvid' );

		return [
			'duplicate' => [
				/* translators: %s: Section label */
				'title' => sprintf( __( 'Duplicate %s', 'streamvid' ), $section_label ),
				'icon' => 'clone',
			],
			'add' => [
				/* translators: %s: Section label */
				'title' => sprintf( __( 'Add %s', 'streamvid' ), $section_label ),
				'icon' => 'plus',
			],
			'save' => [
				/* translators: %s: Section label */
				'title' => sprintf( __( 'Save %s', 'streamvid' ), $section_label ),
				'icon' => 'save',
			],
			'remove' => [
				/* translators: %s: Section label */
				'title' => sprintf( __( 'Remove %s', 'streamvid' ), $section_label ),
				'icon' => 'close',
			],
		];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_additional',
			array(
				'label' => esc_html__( 'Jws Settings', 'streamvid' ),
	   ...
	   $this->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Use Section For', 'streamvid' ),
					'default' => '',
					'options' => array(
						''          => esc_html__( 'Default', 'streamvid' ),
       ...
       $this->start_controls_section(
        ...
        $this->add_control(
				'nav_icon',
				[
					'label' => esc_html__( 'Nav Icon', 'streamvid' ),
        ...
        $this->add_responsive_control(
			'nav_width_height',
			[
				'label' => esc_html__( 'Nav Width Height', 'streamvid' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 90,
        ...
        $this->add_responsive_control(
			'nav_prev_space',
			[
				'label' => esc_html__( 'Nav Prev Space', 'streamvid' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 90,
        ...
        $this->add_responsive_control(
			'nav_next_space',
			[
				'label' => esc_html__( 'Nav Next Space', 'streamvid' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 90,
        ...
        $this->add_control(
				'dots_align',
				[
					'label' 		=> esc_html__( 'Dots Align', 'streamvid' ),
        ...
        $this->add_control(
			'dots_color',
			[
				'label' => esc_html__( 'Dots Color', 'streamvid' ),
        ...
        $this->add_responsive_control(
			'dots_padding',
			[
				'label' => esc_html__( 'Dots Margin', 'streamvid' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
       ...
       $this->start_controls_section(
        ...
        $this->add_control(
			'vertical',
			[
				'label'        => esc_html__( 'Vertical', 'streamvid' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
			]
		);
        ...
        $this->add_control(
			'wheel',
			[
				'label'        => esc_html__( 'Wheel', 'streamvid' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
			]
		);
        ...
        $this->add_control(
			'fade',
			[
				'label'        => esc_html__( 'Fade', 'streamvid' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => '',
			]
