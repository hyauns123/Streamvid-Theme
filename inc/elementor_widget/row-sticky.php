...
class Row_Sticky {
	...
	public function _addStickyEffect( $el ) {
        ...
        $el->add_control(
            ...
            [
                'label' => __('Enable Sticky', 'streamvid'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'streamvid'),
                'label_off' => __('No', 'streamvid'),
                'default' => '',
                'return_value' => 'sticky',
        ...
        $el->add_control(
            'enable_fixed_bottom',
            [
                'label' => __('Fixed to Bottom', 'streamvid'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'streamvid' ),
                'label_off' => __( 'Hide', 'streamvid' ),
                'return_value' => 'menu',
                'default' => '',
        ...
        $el->add_control(
            ...
            [
                'label' => __('Enable Desktop Sticky', 'streamvid'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'streamvid'),
                'label_off' => __('No', 'streamvid'),
                'default' => '',
        ...
        $el->add_control(
            ...
            [
                'label' => __('Enable Tablet Sticky', 'streamvid'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'streamvid'),
                'label_off' => __('No', 'streamvid'),
                'default' => '',
        ...
        $el->add_control(
            ...
            [
                'label' => __('Enable Mobile Sticky', 'streamvid'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'streamvid'),
                'label_off' => __('No', 'streamvid'),
                'default' => '',
        ...
        $el->add_control(
            ...
            [
                'label' => __('Enable Scroll Up Sticky', 'streamvid'),
                'description' => __('Header sticky only when scroll up', 'streamvid'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'streamvid'),
                'label_off' => __('No', 'streamvid'),
                'default' => '',
        ...
        $el->add_responsive_control(
            ...
            [
                'label' => __('Sticky Offset Top', 'streamvid'),
        ...
        $el->add_responsive_control(
            'sticky_transparent',
            [
                'label' => __('Sticky Transparent', 'streamvid'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'streamvid'),
                'label_off' => __('No', 'streamvid'),
                'default' => '',
        ...
        $el->add_control(
            'sticky_effect_color',
            [
                'label' => __('Sticky Color', 'streamvid'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'description' => __('For Clever Header&#8217;s Widgets only.', 'streamvid'),
                'selectors' => [
        ...
        $el->add_control(
            ...
            [
                'label' => __('Sticky Color Hover', 'streamvid'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'description' => __('For Clever Header&#8217;s Widgets only.', 'streamvid'),
                'selectors' => [
        ...
        $el->add_control(
            ...
            [
                'label' => __('Sticky Background Color', 'streamvid'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $el->add_group_control(
            ...
            [
                'label' => esc_html__('Sticky Box Shadow', 'streamvid'),
        ...
        if ($el instanceof Widget_Base) {
            $el->add_control(
                ...
                [
                    'label' => __('Stay In Column', 'streamvid'),
                    'type' => Controls_Manager::SWITCHER,
                    'condition' => [
                        'enable_sticky_effect!' => '',
                    ],
