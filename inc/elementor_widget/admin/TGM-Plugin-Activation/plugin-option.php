	...
	$root = 'https://gavencreative.com/plugins/';
       $plugins = array(   
        ...
        array(
			...
			'source'            => $root . 'paid-memberships-pro.zip',
			'required'          => true,
		),
        ...
        array(
			'name' => 'Streamvid Core',
			'slug' => 'streamvid-core',
		    'source' => $root . 'streamvid/streamvid-core.zip',
			'required' => true,
		),
        ...
        array(
			'name' => 'Jws Streamvid',
			'slug' => 'jws-streamvid',
		    'source' => $root . 'streamvid/jws-streamvid.zip',
			'required' => true,
		),
        
        
        array(
			'name' => 'Jws Tmdb Import',
			'slug' => 'jws-tmdb-import',
		    'source' => $root . 'streamvid/jws-tmdb-import.zip',
			'required' => true,
		),
