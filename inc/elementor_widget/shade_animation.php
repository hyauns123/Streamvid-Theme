...
class shade_Animation {
	...
	public function register_controls( $element, $section_id, $args ) {
		...
		if ( ( 'section' === $element->get_name() && 'section_background' === $section_id ) || ( 'column' === $element->get_name() && 'section_style' === $section_id ) ) {
			...
			$element->start_controls_section(
				...
				[
					...
					'label' =>  esc_html__( 'Shade Animation', 'streamvid' ) , 
				]
			);
            $element->add_control(
				...
				[
					...
					'label'        =>  esc_html__( 'Enable shade Animation', 'streamvid' ),
					'default'      => '',
            ...
            $repeater->add_control(
				...
				[
					'type'         => Controls_Manager::SWITCHER,
					'label'        =>  esc_html__( 'Enable Render Image To Svg Html', 'streamvid' ),
					'default'      => '',
					'label_on'     =>  esc_html__( 'Yes', 'streamvid' ),
					'label_off'    =>  esc_html__( 'No', 'streamvid' ),
					'return_value' => 'yes',
            ...
            $repeater->add_control(
             ...
             $repeater->add_control(
				'shape-animation',
				[
					'label'     =>  esc_html__( 'Animation Name', 'streamvid' ),
					'type'      => Controls_Manager::SELECT,
					'options'   => [
                        'none'   =>  esc_html__( 'None', 'streamvid' ),
						'MoveLeft'   =>  esc_html__( 'Move Left', 'streamvid' ),
                        'MoveRight'   =>  esc_html__( 'Move Right', 'streamvid' ),
						'MoveTop'   =>  esc_html__( 'Move Top', 'streamvid' ),
                        'MoveBottom'   =>  esc_html__( 'Move Bottom', 'streamvid' ),
                        'MoveCircle'   =>  esc_html__( 'Move Circle', 'streamvid' ),
                        'MoveCircleSmall'   =>  esc_html__( 'Circle Small', 'streamvid' ),
                        'MoveCircle360'   =>  esc_html__( 'Move Circle 360', 'streamvid' ),
                        'MoveZoomIn'   =>  esc_html__( 'Zoom In', 'streamvid' ),
                        'MoveZoomOut'   =>  esc_html__( 'Zoom Out', 'streamvid' ),  
					],
                    'selectors' => [
             ...
             $repeater->add_control(
				...
				[
					'label'     =>  esc_html__( 'Animation Timing', 'streamvid' ),
					'type'      => Controls_Manager::SELECT,
					'options'   => [
						'linear'   =>  esc_html__( 'Linear', 'streamvid' ),
						'ease'   =>  esc_html__( 'Ease', 'streamvid' ),
                        'ease-in'   =>  esc_html__( 'Ease In', 'streamvid' ),
            ...
            $repeater->add_control(
        			'shape-duration',
        			[
        				'label' =>  esc_html__( 'Animation Duration', 'streamvid' ),
        				'type' => \Elementor\Controls_Manager::NUMBER,
        				'min' => 0,
        				'max' => 20,
        				'step' => 0.1,
            ...
            $repeater->add_control(
        			'shape-delay',
        			[
        				'label' =>  esc_html__( 'Animation Delay', 'streamvid' ),
        				'type' => \Elementor\Controls_Manager::NUMBER,
        				'min' => 0,
        				'max' => 10,
        				'step' => 0.1,
            ...
            $repeater->add_control(
				...
				[
					'type'         => Controls_Manager::SWITCHER,
					'label'        =>  esc_html__( 'Enable Alternate', 'streamvid' ),
					'default'      => 'yes',
					'label_on'     =>  esc_html__( 'Yes', 'streamvid' ),
					'label_off'    =>  esc_html__( 'No', 'streamvid' ),
					'return_value' => 'yes',
            ...
            $repeater->add_control(
				...
				[
					'type'         => Controls_Manager::SWITCHER,
					'label'        =>  esc_html__( 'Enable Infinite', 'streamvid' ),
					'default'      => 'yes',
					'label_on'     =>  esc_html__( 'Yes', 'streamvid' ),
					'label_off'    =>  esc_html__( 'No', 'streamvid' ),
					'return_value' => 'yes',
            ...
            'custom_width',
            [
                'label' => esc_html__( 'Custom Width', 'streamvid' ),
            ...
            $repeater->add_control(
				...
				[
					'type'         => Controls_Manager::SWITCHER,
					'label'        =>  esc_html__( 'Enable Position X Right', 'streamvid' ),
					'default'      => '',
					'label_on'     =>  esc_html__( 'Yes', 'streamvid' ),
					'label_off'    =>  esc_html__( 'No', 'streamvid' ),
					'return_value' => 'yes',
         ...
         $repeater->add_responsive_control(
            'pos_x', [
                'label' => esc_html__('Position X (%)', 'streamvid'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['%','px'],
                'range' => [
                    '%' => [
        ...
        $repeater->add_control(
				...
				[
					'type'         => Controls_Manager::SWITCHER,
					'label'        =>  esc_html__( 'Enable Position Y Bottom', 'streamvid' ),
					'default'      => '',
					'label_on'     =>  esc_html__( 'Yes', 'streamvid' ),
					'label_off'    =>  esc_html__( 'No', 'streamvid' ),
					'return_value' => 'yes',
        ...
        $repeater->add_responsive_control(
            'pos_y',[
                'label' => esc_html__('Position Y (%)', 'streamvid'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['%','px'],
                'range' => [
                    '%' => [
        ...
        $repeater->add_responsive_control(
         ...
         $repeater->add_responsive_control(
            'custom_opacity',
            [
                'label' => esc_html__( 'Opacity', 'streamvid' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 1,
            ...
            $repeater->add_control(
				...
				[
					'label'     =>  esc_html__( 'Mix Blend', 'streamvid' ),
					'type'      => Controls_Manager::SELECT,
					'options'   => [
                        'inherit'   =>  esc_html__( 'None', 'streamvid' ),
						'multiply'   =>  esc_html__( 'Multiply', 'streamvid' ),
						'darken'   =>  esc_html__( 'Darken', 'streamvid' ),  
					],
                    'selectors' => [
    	   ...
    	   $element->add_control(
    			'shade_list',
    			[
    				'label' =>  esc_html__( 'Shade List', 'streamvid' ),
