...
class CarDealer_Helper_Widget_Product_Reset_All_Filter extends WP_Widget {
   ...
   function __construct() {
		$args = array(
			'name'        => esc_html__( 'JWS Reset All Filter', 'streamvid' ),
			'description' => esc_html__( 'Add product reset widget in product listing top widget area.', 'streamvid' ),
			'classname'   => 'product_reset',
            'customize_selective_refresh' => true,
		);

	   parent::__construct( 'product_reset', __( 'JWS Product Reset All Filter','streamvid' ), $args );
	}
	...
	public function widget( $args, $instance ) {
        ...
        ?>
        <a class="reset-all-filter" href="<?php echo get_permalink( wc_get_page_id( 'shop' ) ); ?>"><?php echo esc_html__('Clear All','streamvid'); ?></a>   
    	<?php
