...
class Zo_Recent_Posts_Widget_With_Thumbnails extends WP_Widget {
	...
	function __construct() {
	   	$args = array(
			'name'        => esc_html__( 'Recent Posts With Thumbnails', 'streamvid' ),
			'description' => esc_html__( '', 'streamvid' ),
			'classname'   => ''
		);
		parent::__construct( 'zo-recent-posts-widget-with-thumbnails', esc_html__( 'Recent Posts With Thumbnails', 'streamvid' ) , $args );
				...
				<div class="tb-recent-detail">
                    ...
                    <?php if ( ! $hide_author ) { ?>
						<div class="tb-post-author">
							<p>		
								<?php 
								echo esc_html__('By ', 'streamvid').'<span>'.get_the_author().'</span>'
								?>
							</p>
					...
					<?php if ( ! $hide_button ) { ?>
						<!-- Btn read mor -->
						<a href="<?php the_permalink(); ?>" class="btn btn-default"><?php esc_html_e('Read More', 'streamvid');?></a>
...
<?php
	...
	function form( $instance ) {
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_thumbnail' )); ?>"><?php esc_html_e( 'Do not show hide_thumbnail?', 'streamvid' ); ?> <em><?php esc_html_e( 'Make sure you set a default thumbnail for posts without a tille.', 'streamvid' ); ?></em></label> </p>
        
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'streamvid' ); ?></label>
		<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>
        
		<p><label for="<?php echo esc_attr($this->get_field_id( 'number_posts' )); ?>"><?php esc_html_e( 'Number of posts to show:', 'streamvid' ); ?></label>
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id( 'image_size' )); ?>"><?php esc_html_e( 'Image Size', 'streamvid' ); ?></label>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php esc_html_e( 'Display post date?', 'streamvid' ); ?></label></p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_title' )); ?>"><?php esc_html_e( 'Do not show title?', 'streamvid' ); ?> <em><?php esc_html_e( 'Make sure you set a default title for posts without a tille.', 'streamvid' ); ?></em></label> </p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_author' )); ?>"><?php esc_html_e( 'Do not show author?', 'streamvid' ); ?> <em><?php esc_html_e( 'Make sure you set a default author for posts without a tille.', 'streamvid' ); ?></em></label> </p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_content' )); ?>"><?php esc_html_e( 'Do not show content?', 'streamvid' ); ?> <em><?php esc_html_e( 'Make sure you set a default content for posts without a content.', 'streamvid' ); ?></em></label> </p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_button' )); ?>"><?php esc_html_e( 'Do not show button read more?', 'streamvid' ); ?> <em><?php esc_html_e( 'Make sure you set a default button for posts without a button.', 'streamvid' ); ?></em></label> </p>
